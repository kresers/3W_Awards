...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // back_home
        if ('/administration/parameters' === $pathinfo) {
            return array (  '_controller' => 'BackBundle\\Controller\\ParametersController::indexAction',  '_route' => 'back_home',);
        }

        // back_form
        if ('/administration/form' === $pathinfo) {
            return array (  '_controller' => 'BackBundle\\Controller\\ParametersController::formAction',  '_route' => 'back_form',);
        }
