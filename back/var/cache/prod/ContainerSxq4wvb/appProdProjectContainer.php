...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZtE4IsrY1K', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'});
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'doctrine_cache.predis.customer.class' => 'Predis\\Client',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'thomas.focqueu@hotmail.fr' => 'thomas.focqueu@hotmail.fr',
            ),
