 ...
 */
class Awards extends \BackBundle\Entity\Awards implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackBundle\\Entity\\Awards' . "\0" . 'id', '' . "\0" . 'BackBundle\\Entity\\Awards' . "\0" . 'name', '' . "\0" . 'BackBundle\\Entity\\Awards' . "\0" . 'project', '' . "\0" . 'BackBundle\\Entity\\Awards' . "\0" . 'categoryAwards'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Awards $proxy) {
    ...
    public function addCategoryAward(\BackBundle\Entity\CategoryAwards $categoryAward)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCategoryAward', [$categoryAward]);

        return parent::addCategoryAward($categoryAward);
    }
    ...
    public function removeCategoryAward(\BackBundle\Entity\CategoryAwards $categoryAward)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCategoryAward', [$categoryAward]);

        return parent::removeCategoryAward($categoryAward);
    }
